...
export default function Login() {
  ...
  const image = {
    uri: 'https://media.istockphoto.com/photos/white-lines-and-spheres-picture-id1135638647?b=1&k=20&m=1135638647&s=170667a&w=0&h=j32QwPBMCmdX9ViKWvitis6N3l3Wl-lBEl1Ut9ImiBk=',
  };
  return (
          ...
          <View>
            ...
            {data.isValidPassword ? (
              ...
              <Text style={Appstyles.errorMsg}>
                Password must be 8 characters long with a mix of letters,
                numbers and simbols.
              </Text>
            )}
          </View>
